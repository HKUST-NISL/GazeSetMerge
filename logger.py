...
def _create_handlers(output_dir: Optional[pathlib.Path] = None,
    ...
    if output_dir is not None:
        handlers.append(
            _create_file_handler(os.path.join(output_dir,filename), color_formatter))
        ...
        handlers.append(
            _create_file_handler(os.path.join(output_dir,plain_log_name), plain_formatter))
    return handlers
...
def _create_file_handler(file_path, 
